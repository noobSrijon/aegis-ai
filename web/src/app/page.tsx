            ...
            {profile?.account_role !== "guardian" && (
              <>
                <button
                  ...
                  className={`px-6 py-2 rounded-full text-sm font-semibold transition-all border ${activeTab === "aegis-ai" ? "bg-[#14B8A6] text-[#0B1120] border-[#14B8A6] shadow-[0_0_20px_rgba(20,184,166,0.3)]" : "text-[#9CA3AF] border-[#0F766E]/50 hover:text-[#E5E7EB] hover:border-[#14B8A6]/50"}`}
                >
                  aegis-ai
                </button>
                <button
          ...
          <div className="max-w-md w-full bg-[#0F172A] border border-[#0F766E]/30 rounded-[32px] p-8 shadow-2xl animate-in zoom-in-95 duration-300">
            {onboardingStep === 0 ? (
              <div className="text-center">
                ...
                <p className="text-[#9CA3AF] text-sm mb-8">How will you be using Aegis AI today?</p>
